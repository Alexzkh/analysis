package com.zqykj.analysis.entity;
 ...
 **/
@ESMetaData(indexName = "main_test_without_type", number_of_shards = 5,number_of_replicas = 0,printLog = false)
public class Main4 implements Serializable {
    ...
    public String toString() {
        return "com.zqykj.analysis.entity.Main2{" +
