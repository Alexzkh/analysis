...
//    private ElasticsearchProperties elasticsearchProperties;
    ...
    /**
     * Get index metadata: configuration of indexname, indextype, primary partition and backup partition number
     * @param clazz
     * @return
     */
...
//            }
            ...
            if(Tools.arrayISNULL(clazz.getAnnotation(ESMetaData.class).searchIndexNames())) {
                ...
                // If searchindexnames is configured, the configuration will prevail
                metaData.setSearchIndexNames((clazz.getAnnotation(ESMetaData.class).searchIndexNames()));
            }
    ...
    /**
     * Get the mapping information configured on the field. If no annotation is configured, the default information will be given
     * @param field
     * @return
     */
    ...
    /**
     * Gets the type in mapping based on the enumeration type
     * @param dataType
     * @return
     */
    ...
    /**
     * Batch obtain the mapping information configured on the field. If no annotation is configured, the default information will be given
     * @param clazz
     * @return
     */
