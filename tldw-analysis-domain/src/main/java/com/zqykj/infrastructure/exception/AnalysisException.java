...
public class AnalysisException extends Exception {
    ...
    public AnalysisException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public AnalysisException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public AnalysisException(final int errCode, final String errMsg, final Throwable throwable) {
