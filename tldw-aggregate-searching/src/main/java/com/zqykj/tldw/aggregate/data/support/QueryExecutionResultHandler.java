...
import com.zqykj.infrastructure.util.NullableWrapper;
...
/**
 * <h1> @Query 查询结果处理器(从Es返回结果后,若是嵌套类型在此处理) </h1>
 */
public class QueryExecutionResultHandler {
    ...
    private static boolean processingRequired(@Nullable Object source, Class<?> targetType) {
        ...
        //
        //
        return !targetType.isInstance(source) || source instanceof Collection;
    }
    ...
    static class ReturnTypeDescriptor {
        ...
        TypeDescriptor nestedTypeDescriptor;
