...
public class SuggestAdjusted {
    ...
    @MultiField(
            ...
            otherFields = {@InnerField(suffix = "account_name_wildcard", type = FieldType.Wildcard)}
    )
    ...
    @MultiField(
            ...
            otherFields = {@InnerField(suffix = "account_feature_wildcard", type = FieldType.Wildcard)}
    )
